...
- Timestamp: `2022-05-10 13:02`
- Build ID: `e5fed950-00a2-4801-a2e2-c97db9fd3f6b`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e5fed950-00a2-4801-a2e2-c97db9fd3f6b.git
$ cd e5fed950-00a2-4801-a2e2-c97db9fd3f6b
```
